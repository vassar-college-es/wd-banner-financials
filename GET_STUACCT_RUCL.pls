create or replace procedure get_stuacct_rucl (p0 in varchar2 default null, p1 in number default 1, p2 in number, p3 in number default 0, p4 in varchar2 default null, ref_cur_out out SYS_REFCURSOR)
as
-- p0 : rucl_code
-- p1 : offset
-- p2 : limit
